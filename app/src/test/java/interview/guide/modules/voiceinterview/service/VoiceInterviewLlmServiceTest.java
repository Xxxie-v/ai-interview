 ...
 * {@link VoiceInterviewLlmService} 旧的 3 参构造器。当前 {@code VoiceInterviewLlmService} 已改为 5 参构造器
 ...
 */
@Disabled(
    "Pending rewrite: RolePrompt removed in commit e6bebe7; VoiceInterviewLlmService constructor "
        + "signature evolved in commit f87f435 / c433a50"
)
@DisplayName("Dashscope LLM 服务测试（待重写）")
class VoiceInterviewLlmServiceTest {
